...
class Checkout {
    ...
    public static function get_kinola_js_url(): string {
        return Kinola_Api::get_kinola_js_url();
    }
    ...
    public static function get_strings(): array {
        return [
            ...
            'giftCard_title' => __('Buy an Electronic Gift Card'),
            'giftCard_note' => __("The gift card does not have a set number of tickets, but rather a specific amount of money that can be deducted from each purchase. The gift card is reusable, meaning any unused balance remains for the next cinema visit."),
            'giftCard_emailNote' => __("If you are purchasing the gift card as a present for someone, you can enter their email address. However, it’s even nicer to send the email yourself along with a personal message."),
